...
$(document).ready(function () {
  ...
  function fetchUsers() {
    ...
    $.ajax({
      type: "GET",
      url: "users/show/?page=".concat(page),
      dataType: "json",
      ...
      success: function success(response) {
        if (response.status == 200) {
          ...
          $.each(response.errors, function (key, err_values) {
            $('#changePassFormErrList').append("<li>".concat(err_values, "</li>"));
          });
        }
      }
    });
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        if (response.status == 404) {
          ...
          $("#edit_".concat(response.user.role.name, "_field")).prop('checked', true);
    ...
    $.ajax({
      ...
      success: function success(response) {
        if (response.status == 400) {
          ...
          $.each(response.errors, function (key, err_values) {
            $('#editFormErrList').append("<li>".concat(err_values, "</li>"));
          });
    ...
    $.ajax({
      ...
      success: function success(response) {
        if (response.status == 400) {
          ...
          $.each(response.errors, function (key, err_values) {
            $('#createFormErrList').append("<li>".concat(err_values, "</li>"));
          });
        } else {
          $('#createFormErrList').html("");
          $('#success_message').addClass('alert alert-success');
